...
class saddle:  # use small letter, cause this acts as a namespace
    ...
    BOTTOM_BEZIER_POINT_LISTS = [  # XY plane 
        [(0.0, 8.25), (3.352, 8.219), (6.150, 8.317), (7.335, 7.211)],
        [(7.335, 7.211), (8.605, 6.203), (8.726, 3.431), (8.75, 0.0)],
    ]
    TOP_BEZIER_POINT_LISTS = [  # XY plane
        [(0.0, 6.5), (2.368, 6.484), (4.452, 6.355), (5.527, 5.395)],
        [(5.527, 5.395), (6.649, 4.495), (6.991, 2.441), (7.0, 0.0)],
    ]
    ...
    SWEEP_FACE_BEZIER_POINT_LISTS = [  # XZ plane (=Sketch14_shape1), (changed sign of all y values)
